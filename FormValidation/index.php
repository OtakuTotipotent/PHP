...
include("connection.php"); // connects the other php files with this code/file
...
if (isset($_POST['submit-btn'])) { // if user clicks submit button on web page
    ...
    if (!empty($roll_no) && !empty($name) && !empty($marks) && is_numeric($marks)) {
        // Prepare the SQL statement to prevent SQL injection
        $stmt = $connection->prepare("INSERT INTO result (rno, sname, marks) VALUES (?, ?, ?)");
        $stmt->bind_param("isi", $roll_no, $name, $marks);
